...
**Notice:** Because there are two kinds of default decoders, `json`, `yaml`, and `INI`, the file is only the format of json or ini. But you can register other decoders to support more format files.
